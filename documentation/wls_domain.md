...
[adminserver_port](#wls_domain_adminserver_port)         | The adIP portdress the admin server process will run and listen on.                       |
...
[nodemanager_address](#wls_domain_nodemanager_address)   | The IP adress the nodemanager will run and listen on.                                     |
