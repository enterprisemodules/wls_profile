...
# ## steps
#
# Defining and starting a WebLogic Admin Server on your system goes through several steps:
#
...
# ```
#
# This mechanism can be used for all named steps and makes it easy to move from an easy setup with a running standard WebLogic Admin server to a fully customized setup using a lot of your own classes plugged in.
#
